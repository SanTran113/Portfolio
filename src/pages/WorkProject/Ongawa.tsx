        ...
        <div className="space-y-[5%] mt-[8%]">
          <section className="text-heading2 text-white font-bold">
            ...
            <p className="text-body font-normal mt-[1%]">
              ...
              provide a platform for new and upcoming musicians to showcase
              their music through rhythm games. By creating beatmaps, levels in
              rhythm games, the player is able to enjoy both gameplay and
          ...
          <section className="text-heading2 text-white font-bold">
            ...
            <p className="text-body font-normal mt-[1%]">
              ...
              Some of these aspects are simple, such as navigation animation,
              from homepage navigation to character animation. Many of the
              layouts of pages were based on these game websites, excluding the
              following:
              <ul className="list-disc ml-[4%] text-body font-normal mt-[1%] mb-[1%]">
                <li className="mt-2">
                  The community page was inspired by Twitter and Reddit
                </li>
                <li className="mt-2">
                  The gallery page was inspired by Pinterest
                </li>
                <li className="mt-2">
                  The header of the Song Page was inspired by Spotify
                </li>
              </ul>
              By analyzing the previous team’s Figma design, we realized that
              the issue mainly stems from cramming a lot of information into one
              page. To fix this, we focused on breathing room and separating
              each section with a clear subheading.
            </p>
            <div className="text-heading3 text-white font-bold mt-[2%]">
              Color Palette:
              <p className="text-body font-normal">
            ...
            <div className="text-heading3 text-white font-bold mt-[2%]">
              Responsive Design:
              <p className="text-body font-normal">
                Each page has a corresponding mobile vertical, mobile
                horizontal, and a web counterpart. Each page was designed for
                the website first, then designed to fit the mobile vertical and
                mobile horizontal, respectively.
              </p>
            </div>
          ...
          <section className="text-heading2 text-white font-bold">
            ...
            <div className="text-body font-normal mt-[1%]">
              ...
              <p className="mb-[2%]">
                ...
                each song (see below). As the song becomes more flexible in
                terms of difficulty, the more the difficulties take room, making
                it difficult for the viewer to look at multiple songs at once
                when deciding which song they may want to download and play. To
                solve this, we have come up with a new way by using a color
                range, where each color coordinates to a difficulty (mirroring
                OSU’s difficulty standard). However, now the website utilizes a
                color range to display the difficulties, making each song layout
                consistent.
              </p>
              <h1 className="font-bold text-heading3">
              ...
              <p className="mb-[2%]">
                ...
                one indent. For example, at the bottom, even though
                QuestComposer is replying to The Shadow Weaver, who has replied
                to Techno Maestro, both QuestComposer and The Shadow Weaver have
                one tab to differentiate which comment thread they are in
                (Techno Maestro’s comment thread).
              </p>
              <p className="mb-[2%]"></p>
            </div>
          </section>
